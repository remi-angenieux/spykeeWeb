				...
				<form method="post" action="/admin/delUser">
					...
					<table wdith=\"100%\" border=\"1px\">
						<tr>
							...
							<th><span class="byline"><a class="button button-alt">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspE-mail&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a></span></th>
						...
						{foreach name=outer item=arr from=$array4}
							<tr>
    							{foreach key=key item=item from=$arr}
        							<td><span class="text">{$item}</span></td>
    						    {/foreach}
