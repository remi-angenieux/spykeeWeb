			...
			<div id="content mobileUI-main-content">
				<article>
					...
					<div id="left">
						...
						<div id="robotMove">
							<p class="center"><input type="button" name="holdingUp" value="Holding Up" onclick="holdingUp()" id="holdingUp" class="up" /><p>
							<p class="left"><input type="button" name="holdingLeft" value="Holding Left" onclick="holdingLeft()" id="holdingLeft" class="up" /></p><p class="right"><input type="button" name="holdingRight" value="Holding Right" onclick="holdingRight()" id="holdingRight" class="up" /></p>
							<p class="center"><input type="button" name="holdingDown" value="Holding Down" onclick="holdingDown()" id="holdingDown" class="up" /></p>
						</div>
						<input type="button" name="stop" value="Stop" onclick="stop()" id="stop" class="clear" />&nbsp;&nbsp;Arrêter le robot
					</div>
					<div id="right">
						<h4>Vitesse :</h4>
						<div id="speed"></div>
						<div id="speedDescription"><p class="lowest">Lent</p>
						<p class="highest">Rapide</p></div>
						<p>
						<!-- <br />
						<br />
